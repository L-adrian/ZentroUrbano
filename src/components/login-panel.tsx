...
export function LoginPanel({ authEnabled }: { authEnabled: boolean }) {
  ...
  return <div className="auth-panel">
    ...
    <form onSubmit={submit}>
      ...
      <label><span><Mail size={15} />Correo electrónico</span><input type="email" value={email} onChange={event => setEmail(event.target.value)} autoComplete="email" required placeholder="tu@correo.com" /></label>
